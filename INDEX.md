# 30 Days of Cybersecurity — Navigation Hub

Welcome to the interconnected vault. This index serves as your entry point to explore the internship documentation through multiple pathways.
...
```
┌─────────────────────────────────────────────────────────────┐
│         CYBERSECURITY DOMAINS IN THIS VAULT                 │
├─────────────────────────────────────────────────────────────┤
│ Network Security           (Port scanning, DoS, packet analysis)  │
│ Linux & Operating Systems  (Permissions, user management, FHS)    │
│ Cryptography              (Hashing, password cracking)            │
│ Web Application Security  (Burp Suite, HTTP testing, SQL injection)│
│ Social Engineering        (Phishing, credential harvesting)       │
│ Offensive Security        (Metasploit, exploitation, privilege escalation)│
└─────────────────────────────────────────────────────────────┘
```
...
## Graph View Tips (Obsidian)

This vault is optimized for Obsidian's graph visualization:

- **Blue nodes** = Core concepts and domains
- **Green nodes** = Daily logs and weeks
- **Orange nodes** = Tools and techniques
- **Purple nodes** = Cross-references and bridges

All links are intentional—use the graph view to discover patterns and relationships across domains.

---

## About This Repository

- **Purpose:** Public journal of a cybersecurity internship with verifiable commit history
- **Scope:** 30 days of hands-on learning across 6 major domains
...
- Use **Obsidian's graph view** to visualize connections between concepts, tools, and days
- Use **backlinks** (Ctrl+Alt+B / Cmd+Opt+B) to see what links to a specific note
- Use **search** (Ctrl+Shift+F / Cmd+Shift+F) to find concepts or tools across all files
- Use **quick switcher** (Ctrl+P / Cmd+P) to jump between daily logs by date

---

**Last updated:** 2026-06-23 | **Current progress:** 14/30 days | **Domains covered:** 6/6
